...
public class testRemindAdd {
	@Test
	public void test()throws Exception{
		RemindUser a=new RemindUser();
		a.setContent("wwwwwwww");
		a.setReceiverId(8);
		a.setIdentifying((byte) 1);  // 备忘提醒为1，课程提醒为0
		...
		HttpPost post=new HttpPost("http://localhost:8080/MoblicLearningCommunity/service/RemindAdd");
