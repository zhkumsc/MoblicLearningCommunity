...
public class TestMessageGet4Friend {

	@Test
	public void getMsg() throws Exception {
		URL url = new URL(
				"http://localhost:8080/MoblicLearningCommunity/service/MessageGet4Friend");
		...
		Collection c = JSONArray.toCollection(JSONArray.fromObject(jsonString), UserChatrecords.class);
