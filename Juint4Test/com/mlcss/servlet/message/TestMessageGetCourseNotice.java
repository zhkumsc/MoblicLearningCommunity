...
public class TestMessageGetCourseNotice {

	@Test
	public void testReceived() throws Exception {
		URL url = new URL(
				"http://localhost:8080/MoblicLearningCommunity/service/MessageGetCourseNotice");
		...
		Collection c = JSONArray.toCollection(JSONArray.fromObject(jsonString), CoursesNotice.class);
